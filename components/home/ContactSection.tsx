    ...
    <section id="contact" className="border-t border-stone-200 bg-stone-100">
      <div className="mx-auto max-w-3xl px-6 py-24 text-center sm:px-10">
        ...
        <a
          ...
          className="mt-8 inline-flex items-center gap-2 border border-stone-900 px-6 py-3 text-sm tracking-wide text-stone-900 transition hover:bg-stone-900 hover:text-stone-50 active:scale-[0.93]"
        >
          {EMAIL_CONTACT}
        </a>
      </div>
